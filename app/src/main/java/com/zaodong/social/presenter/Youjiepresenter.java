...
public
class Youjiepresenter implements IYoujiepresenter{
    private Service service;
    private Youjiaview youjiaview;

    public Youjiepresenter(Youjiaview youjiaview) {
        this.youjiaview = youjiaview;
    ...
    public void loadData(String userid, String page, String counts) {
        ...
        service.youjia(stringStringHashMap)
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            if (string3.contains("user_id")){
                                ...
                                youjiaview.showData(jokerbean);
                            }else {
                                Yzmfbean yzmfbean = gson.fromJson(string3, Yzmfbean.class);
                                youjiaview.showDataf(yzmfbean);
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
