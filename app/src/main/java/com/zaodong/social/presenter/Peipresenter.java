...
public class Peipresenter implements IPeipresenter{
    private Service service;
    private Peiview peiview;

    public Peipresenter(Peiview peiview) {
    ...
    public void showData(String userid) {
        ...
        service.peizhi(stringStringHashMap)
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            Log.e("peizhi",string3);
                            Gson gson = new Gson();
                            if (string3.contains("chat_number")){
                                Peibean peibean = gson.fromJson(string3, Peibean.class);
                                peiview.showData(peibean);
                            }else {
