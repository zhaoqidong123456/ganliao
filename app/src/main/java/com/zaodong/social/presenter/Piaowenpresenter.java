...
public
class Piaowenpresenter implements IPiaowenpresenter{
    private Service service;
    private Piaoview piaoview;

    public Piaowenpresenter(Piaoview piaoview) {
        this.piaoview = piaoview;
    ...
    public void loadData(String userid) {
        ...
        service.piao_wen(stringStringHashMap)
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            if (string3.contains("id")){
                                Piaowenbean piaowenbean = gson.fromJson(string3, Piaowenbean.class);
                                piaoview.showDatapiao(piaowenbean);
                            }else {
    ...
    @Override
    public void loadDataliao(String userid) {
        final String string= RetrofitUrl.key+RetrofitUrl.channel+userid+RetrofitUrl.version1;
        String string1 = MD5Utils.MD5(string);
        String string2 = string1.toUpperCase();
        HashMap<String, String> stringStringHashMap = new HashMap<>();
        ...
        stringStringHashMap.put("sig",string2);
        stringStringHashMap.put("version",RetrofitUrl.version1);
        service.piao_liao(stringStringHashMap)
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<ResponseBody>() {
                    @Override
                    ...
                    public void onNext(@NonNull ResponseBody responseBody) {
                        try {
                            ...
                            if (string3.contains("1")){
                                Piaoliaobean piaoliaobean = gson.fromJson(string3, Piaoliaobean.class);
                                piaoview.showDataliao(piaoliaobean);
                            }else {
