...
public class Jokerpresenter implements IJokerpresenter{
    ...
    @Override
    public void loadDatajoker(String userid, String page, String counts) {
                    ...
                    public void onNext(ResponseBody responseBody) {
                        try {
                            ...
                            if (string3.contains("1")){
                                ...
                                jokerview.showJoker(jokerbean);
                            }else {
                                Yzmfbean yzmfbean = gson.fromJson(string3, Yzmfbean.class);
                                jokerview.showJokerf(yzmfbean);
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
