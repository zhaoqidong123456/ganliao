...
public class AVChatKit {
    ...
    public static void setExtendMessage(IExtendMessage extendMessage){
        AVChatKit.extendMessage = extendMessage;
    }
    ...
    public static void outgoingCall(Context context, String account, String displayName, int callType, int source) {
        ...
        IExtendMessage extendMessage = getExtendMessage();
        if (extendMessage!=null && extendMessage.videoBean()!=null){
            AVChatVideoBean avChatVideoBean = extendMessage.videoBean();
              videoStr = JSONObject.toJSONString(avChatVideoBean);
        }
        AVChatActivity.outgoingCall(context, account, displayName, callType, source,videoStr);
    }
