...
public class AVChatController {
    ...
    public void doCalling(String account, final AVChatType avChatType,
        ...
        doCalling(account, avChatType, callback, null);
    }

    public void doCalling(String account, final AVChatType avChatType,
                          final AVChatControllerCallback<AVChatData> callback, String extendMessage) {
    ...
    public void hangUp(int type) {
        ...
        if ((type == AVChatExitCode.HANGUP || type == AVChatExitCode.PEER_NO_RESPONSE ||
            ...
            AVChatManager.getInstance().hangUp2(avChatData.getChatId(), new AVChatCallback<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Log.e("+=======", "onSuccess:== ");
                        AVChaitKitManager.getInstance().releaseVideoListener.releaseVideoResources(AVChatExitCode.HANGUP);
                }
                @Override
                public void onFailed(int code) {
