    ...
    private static String getMsgDigest(IMMessage msg) {
        switch (msg.getMsgType()) {
            ...
            case robot:
                return "[机器人消息]";
            default:
                if (msg.getAttachment() instanceof  GiftsAttachment){
                    return "礼物";
                }
                return "[自定义消息] ";
        }
        ...
        if (recentCustomization == null) {
            recentCustomization = new DefaultRecentCustomization() {
                ...
                public String getDefaultDigest(RecentContact recent) {
                    ...
                    if (recent.getAttachment() instanceof  GiftsAttachment){
                        return "[礼物]";
                    }
    ...
    private static void setSessionListener() {
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                UIKitManager.getInstance().detailListener.onIntentUserInfoListener(context ,message.getFromAccount());
