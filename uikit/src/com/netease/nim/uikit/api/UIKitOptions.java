...
public class UIKitOptions {
    ...
    public boolean loadSticker = false;
     ...
     */
    public int messageLeftBackground = R.drawable.other_chat_background;
    /**
     * IM 发送出去的消息时，内容区域背景的drawable id
     */
    public int messageRightBackground = R.drawable.my_chat_background;
