...
public class MessageFragment extends TFragment implements ModuleProxy {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        svgaImageView = rootView.findViewById(R.id.mSVGAKninghtood);
        return rootView;
    }
    ...
    public boolean sendMessage(IMMessage message) {
        ...
        OnShowSendGiftsAnimationListener giftsAnimationListener = UIKitManager.getInstance().giftsAnimationListener;

        if (giftsAnimationListener == null) {
            return true;
        }
        giftsAnimationListener.onShowGiftsAnimationListener(getContext(), message, svgaImageView);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch(requestCode) {
            ...
            case Constants.REQUEST_CODE_TAKE:

                SendImageHelper.sendImageAfterSelfImagePicker(getActivity(), data, new SendImageHelper.Callback() {
                    @Override
                    public void sendImage(File file, boolean isOrig) {
                        IMMessage message;
                        if (sessionType != null && sessionType == SessionTypeEnum.ChatRoom) {
                            message = ChatRoomMessageBuilder.createChatRoomImageMessage(sessionId, file, file.getName());
                        } else {
